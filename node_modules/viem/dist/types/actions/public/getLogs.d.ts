...
export type GetLogsReturnType<TAbiEvent extends AbiEvent | undefined = undefined, TStrict extends boolean | undefined = undefined, _EventName extends string | undefined = MaybeAbiEventName<TAbiEvent>> = Log<bigint, number, TAbiEvent, TStrict, [TAbiEvent], _EventName>[];
/**
 ...
 */
export declare function getLogs<TChain extends Chain | undefined, TAbiEvent extends AbiEvent | undefined, TStrict extends boolean | undefined = undefined>(client: Client<Transport, TChain>, { address, blockHash, fromBlock, toBlock, event, args, strict: strict_, }?: GetLogsParameters<TAbiEvent, TStrict>): Promise<GetLogsReturnType<TAbiEvent, TStrict>>;
