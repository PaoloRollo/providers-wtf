...
export type OnLogsParameter<TAbi extends Abi | readonly unknown[] = readonly unknown[], TEventName extends string = string, TStrict extends boolean | undefined = undefined> = TAbi extends Abi ? Log<bigint, number, ExtractAbiEvent<TAbi, TEventName>, TStrict>[] : Log[];
export type OnLogsFn<TAbi extends Abi | readonly unknown[] = readonly unknown[], TEventName extends string = string, TStrict extends boolean | undefined = undefined> = (logs: OnLogsParameter<TAbi, TEventName, TStrict>) => void;
