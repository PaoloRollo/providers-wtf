 ...
 * })
 */
export declare function getTransactionReceipt<TChain extends Chain | undefined>(client: Client<Transport, TChain>, { hash }: GetTransactionReceiptParameters): Promise<import("../../index.js").ExtractFormatterReturnType<TChain, "transactionReceipt", import("../../index.js").TransactionReceipt>>;
