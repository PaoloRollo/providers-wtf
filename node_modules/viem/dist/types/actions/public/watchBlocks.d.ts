 ...
 * })
 */
export declare function watchBlocks<TTransport extends Transport, TChain extends Chain | undefined>(client: Client<TTransport, TChain>, { blockTag, emitMissed, emitOnBegin, onBlock, onError, includeTransactions, poll: poll_, pollingInterval, }: WatchBlocksParameters<TTransport, TChain>): WatchBlocksReturnType;
export {};
